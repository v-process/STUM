...
public class MainActivity extends ActionBarActivity {
    ...
    String[] menuItems = new String[]{"TextFragment", "ImageFragment", "ButtonFragment"};

    TextFragment fragText;
    ImageFragment fragImage;
    ButtonFragment fragButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragButton = new ButtonFragment().newInstance();
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch(position){
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        getSupportFragmentManager().beginTransaction().replace(R.id.fl_activity_main, fragButton).commit();
                        break;
                }
