...
/////////////////////////////////////////MHS  버튼 들과 그에 필요한 작업들...//////////////////////////////////////////////////////
        ...
        //블루투스 켜기 끄기
        mBtTb=(ToggleButton)this.findViewById(R.id.bt_onoff);
        ...
        //건너뛰기
        final Button passActivityBt=(Button)this.findViewById(R.id.jump);
        passActivityBt.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                //그냥 넘어가는 화면
